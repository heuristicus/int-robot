...
The Hokuyo laser is mounted on the front of the robot. It has a scan area of $240^o$ with a maximum radius of four metres.\cite{hokuyo}.
...
\begin{figure}
  ...
  \caption{ROC analysis of frontal\_face\_alt cascade with assumption and sensor models applied.}
  \label{fig:haar}
\end{figure}
\subsection{Exploration}
\begin{figure}
  \includegraphics[width=\columnwidth]{4-1_1_heatmap}
  \caption{Heat map of the best cell based strategy run looping 4m, 2m then 1m cell sizes. Red areas are those which were often in the robot's field of view, while blue areas were not.}
  \label{fig:heatmap}
\end{figure}
...
\begin{figure}
  \includegraphics[width=\columnwidth]{coverage_time}
